    ...
    return (
        <div className="flex items-center w-full">
            <ResponsiveContainer width="100%" height="100%">
                ...
                >
                    <Pie data={articlesSortedByReactions} dataKey="publicReactionsCount" nameKey="title" cx="50%" cy="50%" outerRadius="50%" fill="#3B49DF" />
                    <Pie data={articlesSortedByViews} dataKey="pageViewsCount" nameKey="title" cx="50%" cy="50%" innerRadius="60%" outerRadius="100%" fill="#82ca9d" />
